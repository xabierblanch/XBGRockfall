...
for i in range (1,len(dates)):
    ...
    now = datetime.now()
    os.mkdir(dirpath + "/" + dates[i] + "_" + dates[i+1] + "_" +  project_name + "/")
    project_path=(dirpath + "/" + dates[i] + "_" + dates[i+1] + "_" +  project_name)
    os.mkdir(project_path + "/1_process_files")
    os.mkdir(project_path + "/2_results")
    os.mkdir(project_path + "/2_results/DensePointClouds")
    os.mkdir(project_path + "/2_results/M3C2")
    ...
    file_name = [dates[i],dates[i+1]]
    
    print ("The Script will run this comparison: {} vs {}.".format(dates[i],dates[i+1]))
    ...
    os.system('"C:/Program Files/Agisoft/Metashape Pro/metashape.exe" --gui -r ' + dirpath + "/2_lib/metashape_aligment.py " + project_path + " " + project_name + " " + dirpath)     
    ...
    os.system('"C:/Program Files/Agisoft/Metashape Pro/metashape.exe" -r ' + dirpath + "/2_lib/export_point_coordinate_precision_MJames_[mod].py " + project_path + " " + project_name)            
    ...
    os.system("cmd /c" '"C:/Program Files/Agisoft/Metashape Pro/metashape.exe" --gui -r ' + dirpath + "/2_lib/metashape_densecloud.py " + project_path + " " + project_name)        
    ...
    [file1,file2]=os.listdir(project_path + '/2_results/DensePointClouds')
    
    path_file_1 = project_path + '/2_results/DensePointClouds/' + file1
    path_file_2 = project_path + '/2_results/DensePointClouds/' + file2    
    path_M3C2_file = project_path + '/2_results/M3C2/' + file1[0:len(file1)-4] + '_' + file2[0:len(file1)-4] + '.xyz'
